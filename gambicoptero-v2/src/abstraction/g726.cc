...
/*
 ...
 ----------------------------------------------------------------------------
*/
void G726_encode(short *inp_buf, short *out_buf, long smpno, char *law, SHORT r,
                 SHORT rate, G726_state *state)
{
  short           s;
  short           d, i;
  short           y;
...
/*
 ...
 ----------------------------------------------------------------------------
*/
void G726_decode(short *inp_buf, short *out_buf, long smpno, char *law, SHORT r,
                 SHORT rate, G726_state *state)
{
  short           i;
  short           y;
  ...
  for (j = 0; j < smpno; j++, r = 0)
  {
    ...
    /* Process 4.2.8 */
    G726_compress(&sr, &l, &sp);
    G726_expand(&sp, &l, &slx);
    G726_subta(&slx, &se, &dx);
    G726_log(&dx, &dlx, &dsx);
    G726_subtb(&dlx, &y, &dlnx);
    G726_sync(rate, &i, &sp, &dlnx, &dsx, &l, &sd);

    if (pcm)
    {
      G726_expand(&sd, &l, &sd);
      G726_subta(&sd, &aux, &sd);
    }
...
/*
 ...
 ----------------------------------------------------------------------
*/
void G726_accum(short *wa1, short *wa2, short *wb1, short *wb2, short *wb3,
                short *wb4, short *wb5, short *wb6, short *se, short *sez)
{
  unsigned long   sezi;
...
/*
 ...
 ----------------------------------------------------------------------
*/
void G726_upa2(short *pk0, short *pk1, short *pk2, short *a2, short *a1,
               short *sigpk, short *a2t)
{
...
/*
 ...
 ----------------------------------------------------------------------
*/
void G726_sync(SHORT rate, short *i, short *sp, short *dlnx, short *dsx,
               char *law, short *sd)
{
