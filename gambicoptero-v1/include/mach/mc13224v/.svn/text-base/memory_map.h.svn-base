...
template <> struct IO_Map<MC13224V>
{
	enum {
        ...
        // 8 bit registers
        I2C_BASE        = 0x80006000,
        I2C_ADDR        = 0x80006000 + 0x00,
        I2C_FREQ_DIV    = 0x80006000 + 0x04,
        I2C_CONTROL     = 0x80006000 + 0x08,
        I2C_STATUS      = 0x80006000 + 0x0C,
        I2C_DATA        = 0x80006000 + 0x10,
        I2C_FILTER_SAMP = 0x80006000 + 0x14,
        I2C_CLK_EN      = 0x80006000 + 0x18,
